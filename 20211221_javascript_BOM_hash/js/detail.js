...
console.log($hash);  //#nike_0
var $hash_txt = $hash.replace("#", "");
console.log($hash_txt);  //nike_0

var $divide_arr = $hash_txt.split("_");
console.log($divide_arr);  //['nike', '0']
//$divide_arr[0] : 카테고리 정의
//$divide_arr[1] : 각 카테고리의 데이터 인덱스 번호
...
//하단의 "List View(목록보기)" 클릭시
var backBtn = document.querySelector(".history button");

backBtn.addEventListener("click", function(){
  //history.back();
  // history.go(-1);  //방문기록상 한 단계 뒤로 보낸다. (history 객체)
